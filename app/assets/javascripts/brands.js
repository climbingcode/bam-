...
var copyOperations = {
 ...
 addNewCopy: function(data) {
   ...
   var copyWrapper = $('<div>').attr("id", "copie" + data.id).addClass('brand-copy-text col-sm-10');
   ...
   $(".brand-copy-text .delete-asset").on('click', function(event) {
...
var guidelineOperations = {
 ...
 addNewGuide: function(data) {
   ...
   var guideWrapper = $('<div>').addClass('guide-text col-sm-10').attr("id", "guideline" + data.id);
